...
namespace JoinDev.Infra.Data.Migrations
{
    ...
    [Migration("20230108153153_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JoinDev.Domain.Entities.UserSecretInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("UsersSecretInfo", (string)null);
                });
            ...
            modelBuilder.Entity("JoinDev.Domain.Entities.UserSecretInfo", b =>
                {
                    b.HasOne("JoinDev.Domain.Entities.User", "User")
                        .WithOne("UserSecretInfo")
                        .HasForeignKey("JoinDev.Domain.Entities.UserSecretInfo", "UserId")
                        .IsRequired();
